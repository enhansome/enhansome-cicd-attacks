...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,370 | 🐛 166 | 🌐 Rust | 📅 2026-08-18 - Static analysis for GitHub Actions.
...
* [Gato-X](https://github.com/AdnaneKhan/Gato-X) ⭐ 571 | 🐛 21 | 🌐 Python | 📅 2026-07-20 - GitHub Attack Toolkit - Extreme Edition.
* [Nord Stream](https://github.com/synacktiv/nord-stream) ⭐ 372 | 🐛 1 | 🌐 Python | 📅 2026-07-10 - A tool to extract secrets stored inside CI/CD environments.
